...
public class FavoritesRepositoriesFragment extends SuperFragment implements RepositoryAdapter.OnClickButtons {
    ...
    private void initList() {
        ...
        RepositoryAdapter repositoryAdapter = new RepositoryAdapter(getActivity(), getString(R.string.text_button_one), R.color.colorRed, R.drawable.shape_line_background_red, repositoryEntries, this);
